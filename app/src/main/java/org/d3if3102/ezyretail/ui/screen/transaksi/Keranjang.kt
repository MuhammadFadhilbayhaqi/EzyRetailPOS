...
//
//@Composable
//fun KeranjangItemComposable(item: Keranjang) {
//    Row(
//        modifier = Modifier
//            .fillMaxWidth()
//            .padding(16.dp)
...
//            val produkRef = db.collection("produk").document(item.id)
//
//            // Periksa apakah dokumen produk ada
//            produkRef.get().addOnSuccessListener { document ->
//                if (document.exists()) {
//                    // Jika produk ada, kurangi stok
//                    batch.update(produkRef, "stok", FieldValue.increment(-item.jumlah.toLong()))
//                } else {
//                    // Jika produk tidak ada, tambahkan pesan kesalahan
//                    onComplete(false, "Produk ${item.namaProduk} tidak ditemukan.")
//                    return@addOnSuccessListener
//                }
//            }.addOnFailureListener { e ->
